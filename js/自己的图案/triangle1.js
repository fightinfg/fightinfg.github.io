...
window.onload = function init() {
	...
	for (var i = 0; i <= N1; i++) {
		...
		var x = r * Math.sin(theta)+3/16;
		var y = r * Math.cos(theta)+1/8;
		vertexData.push(x, y);
	}
	
	/**
	//折线
	vertexData.push(0.2,0.55);
	vertexData.push(0.3,0.6);
	vertexData.push(0.25,0.5);
	**/
...
function render() {
	...
	gl.drawArrays(gl.TRIANGLE_FAN, 362+4+1,362+4+1); 
