...
function initTriangles(){
	...
	var w = vec3.fromValues( vertices[6], vertices[7], vertices[8] );
 	...
 	document.getElementById( "inputValue" ).onchange = function( event ){
 		numTimesToSubdivide =  event.target.value;
		initTriangles();
 	}
	document.getElementById( "inputValue2" ).onchange = function( event ){
...
function renderTriangles(){
	...
	//setTimeout( function(){ requestAnimFrame( renderTriangles ); }, speed );
}